...
- [x] **PDOC-05**: A reader can discover all plugin documentation from a `docs/plugins/` index linked from the README.
...
| PDOC-05 | Phase 23 — Authoring Guide & Docs Index | Complete |
